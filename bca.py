...
message = \
    "Subject: Invitation to Engagement Program BCA – Join Us Online!"\
    "\n"\
    "\n"\
    "Dear Student,"\
    "\n"\
    ...
    "Details:"\
    "\n"\
    "Date & Time: 03:00PM TO 04:00OM (Every Friday Online Mode)"\
    "\n"\
    "Platform: Microsoft Teams"\
    "\n"\
    "Online Class Link: https://tinyurl.com/55jrjbfa"\
    "\n"\
